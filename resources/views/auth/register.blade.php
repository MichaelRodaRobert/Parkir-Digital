...
<head>
    ...
    <title>Register - Parkir Online</title>
    ...
    <style>
        * {
        ...
        body {
            margin: 0;
            min-height: 100vh;
            /* Background serasi dengan Welcome & Login */
            background:
    ...
    <div class="container d-flex justify-content-center px-3">
        <div class="register-card">
            ...
            <div class="text-center mb-4">
                ...
                <p class="small text-light text-opacity-75 mt-1">Buat akun baru Anda</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <!-- NAME INPUT -->
                <div class="mb-3">
                    <label for="name" class="form-label small font-weight-bold text-light opacity-90">Nama Lengkap</label>
                    <input id="name"
                           type="text"
                           name="name"
                           value="{{ old('name') }}"
                ...
                <div class="mb-4">
                    <label for="password_confirmation" class="form-label small font-weight-bold text-light opacity-90">Konfirmasi Password</label>
            ...
            <div class="text-center mt-4 pt-3 border-top border-white border-opacity-10 small text-light opacity-75">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="text-info fw-bold ms-1">Masuk Sekarang</a>
            </div>
